...
flagb8.btl: flagb8.cfb 
	$(COLLECT) flagb8.cfb /o flagb8.btl $(COLLECTOPT)

flagb8.cfb: flagb8.pgm flagboss.c4h flaglast.c4h flagwrkr.c4h 
	$(OCONFIG) flagb8.pgm /o flagb8.cfb $(OCONFOPT)
